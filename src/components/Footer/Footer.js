...
export const Footer = () => {
  return (
    <footer className="pt-10 pb-2">
      <div className="flex flex-wrap items-center justify-center sm:justify-between gap-6 py-10">
        ...
        <div className="flex items-center justify-between gap-6">
          <div className="mt-1">
            <Link
              ...
              className="text-content-gray hover:text-black text-base md:text-lg"
            >
              info@webdito.site
            </Link>
          </div>
