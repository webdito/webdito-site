...
export const ProjectCard = () => {
  return (
    <article className="bg-white shadow-projectCard rounded-3xl overflow-hidden">
      <div>
        <Image
          width={100}
          height={100}
      ...
      <div className="flex flex-col gap-3 p-4">
        <h3 className="text-block font-bold text-lg">
          این یک پروژه تمرینی است
        </h3>
        <p className="text-content-gray">
          این نمونه شرح پروژه است. موارد تصادفی اینجا در توضیحات هستند.
        </p>
